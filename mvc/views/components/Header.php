<div class="header navbar" style=" background: linear-gradient(to right, #2193b0, #6dd5ed);">
        ...
        <ul class="nav-left">
            ...
            <li class="search-box">
                <a class="search-toggle" href="javascript:void(0);">
                    <i class="search-icon mdi mdi-magnify" style="color:white"></i>
                    <i class="search-icon-close mdi mdi-close-circle-outline" style="color:white"></i>
                </a>
            </li>
        ...
        <ul class="nav-right">
            <li class="dropdown dropdown-animated scale-left">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <i class="mdi mdi-apps" style="color:white"></i>
                </a>
            ...
            <li class="notifications dropdown dropdown-animated scale-left">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <i class="mdi mdi-bell-ring-outline" style="color:white"></i>
                </a>
            ...
            <li class="m-r-10">
                <a class="quick-view-toggler" href="javascript:void(0);">
                    <i class="mdi mdi-format-indent-decrease" style="color:white"></i>
                </a>
            </li>
        </ul>
    </div>
